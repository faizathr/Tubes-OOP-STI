 ...
 * @author David
 */
public class SnowPeaJPanel extends javax.swing.JPanel {
    StartUpFrame mainframe;
    /**
     * Creates new form SunflowerJPanel
     * @param mainframe
     */
    public SnowPeaJPanel(StartUpFrame mainframe) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Snowpea.gif"))); // NOI18N
        add(jLabel2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SnowPea.png"))); // NOI18N
        add(jLabel1);
