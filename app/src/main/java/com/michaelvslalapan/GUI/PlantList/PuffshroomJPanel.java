 ...
 * @author David
 */
public class PuffshroomJPanel extends javax.swing.JPanel {
    StartUpFrame mainframe;
    /**
     * Creates new form SunflowerJPanel
     * @param mainframe
     */
    public PuffshroomJPanel(StartUpFrame mainframe) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PuffShroom.gif"))); // NOI18N
        add(jLabel2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Puffshroom.png"))); // NOI18N
        add(jLabel1);
