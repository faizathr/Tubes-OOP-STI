 ...
 * @author David
 */
public class LilypadJPanel extends javax.swing.JPanel {
    StartUpFrame mainframe;
    /**
     * Creates new form SunflowerJPanel
     */
    public LilypadJPanel(StartUpFrame mainframe) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Lilypad.gif"))); // NOI18N
        add(jLabel2);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Lilypad.png"))); // NOI18N
        add(jLabel1);
